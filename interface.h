...
//Interface setting 
  ...
  Eext.Colors(GREEN,WHITE,SQUARED,NOFILL);
  Rext.Coords(235,119,265,149);
  Rext.Colors(GREEN,WHITE,SQUARED,NOFILL);
  Fan.Coords(270,119,300,149);
  Fan.Colors(RED,WHITE,SQUARED,NOFILL);
  Fan.ReDraw();
  Bsd.Coords(200,154,230,184);
  Bsd.Colors(GREEN,WHITE,SQUARED,NOFILL);
  Bmc.Coords(270,154,300,184);
  Bmc.Colors(GREEN,WHITE,SQUARED,NOFILL);
  Bpr.Coords(200,189,230,219);
  Bpr.Colors(GREEN,WHITE,SQUARED,NOFILL);
  Bpr.ReDraw();
  Brk.Coords(235,189,265,219);
  Brk.Colors(RED,WHITE,SQUARED,NOFILL);
  Brk.ReDraw();
  Bst.Coords(270,189,300,219);
  Bst.Colors(RED,WHITE,SQUARED,NOFILL);
...
//Buttons setting
  ...
  XH.Colors(GREEN,WHITE,SQUARED,NOFILL);
  YH.Colors(GREEN,WHITE,SQUARED,NOFILL);
  ZH.Colors(GREEN,WHITE,SQUARED,NOFILL);
  UB.Colors(BLUE,WHITE,SQUARED,NOFILL);
  LB.Colors(BLUE,WHITE,SQUARED,NOFILL);
  RB.Colors(BLUE,WHITE,SQUARED,NOFILL);
  DB.Colors(BLUE,WHITE,SQUARED,NOFILL);
  UZ.Colors(RED,WHITE,SQUARED,NOFILL);
  DZ.Colors(RED,WHITE,SQUARED,NOFILL);
